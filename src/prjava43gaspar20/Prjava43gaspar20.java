...
public class Prjava43gaspar20 extends Frame
   ...
   public Prjava43gaspar20 () {
      ...
      setTitle("nova finestra prjava43gaspar20");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43gaspar20();  // Let the construct do the job
   }
